...
import ClassesPackage.UpdateTeacherPojo;
...
public class UpdateTeacher extends HttpServlet {
	...
	try {	
		...
		UpdateTeacherPojo s=new UpdateTeacherPojo();
		...
		con=connect.Dbconnect();
		 ...
		 if (fstname.equals("null") || lstname.equals("null")|| dateob.equals("null")|| addess.equals("null") ||fstname.isEmpty() || lstname.isEmpty()|| dateob.isEmpty()|| addess.isEmpty()||desg.isEmpty() ) {
				response.sendRedirect("UpdateTeachernull.jsp");
			}else {
				stmt.executeUpdate("update Teacher set FirstName='"+fstname+"', Lastname='"+lstname+"',DOB='"+dateob+"',Address='"+addess+"',Phone='"+phn+"',Desgination='"+desg+"' where ID='"+tId+"'");
				response.sendRedirect("UpdateNewTeacher.jsp");
			}
	}
