...
<h2>Edit a Subject with ID No <%out.println(request.getParameter("id")); %></h2>
			<%String id=request.getParameter("id"); %>
			<form class=formcss action="UpdateSubject?id=<%=id%>" method="post">
				<div class="username">
					<h6 class="cName">Subject Name</h6>
					<input class="box" type="text" name=name
						placeholder="Enter the Subject Name"> <br>
				</div>
